...
namespace Movies.Application.Migrations
{
    ...
    [Migration("20250713012001_InitialIdentitySchema")]
    partial class InitialIdentitySchema
    {
        /// <summary>
        /// Configures the Entity Framework Core model for the initial ASP.NET Core Identity schema using GUID keys and PostgreSQL-specific settings.
        /// </summary>
